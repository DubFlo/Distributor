...
public class VendingMachineMain {
	...
	private static Context config() {
		...
		c.gridy = NBR_DRINKS + NBR_COINS + 3;	c.gridx = 0;
		myPanel.add(sugarCubesNbrLabel, c);
		c.gridx = 1;
		myPanel.add(sugarCubesNbrValue, c);
		
		c.gridy = NBR_DRINKS + NBR_COINS + 4;	c.gridx = 0;
		myPanel.add(cupsNbrLabel, c);
		c.gridx = 1;
		myPanel.add(cupsNbrValue, c);
		
		c.gridy = NBR_DRINKS + NBR_COINS + 5;	c.gridx = 0;
		...
		c.gridy = NBR_DRINKS + NBR_COINS + 6; c.gridx = 0; c.gridwidth = GridBagConstraints.REMAINDER;
